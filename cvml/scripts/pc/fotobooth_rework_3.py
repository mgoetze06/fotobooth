...
def handleFrame(event,fotobooth,mouse_clicked,lock):
...
def handleStatus(new_image_to_display,fotobooth,mouse_clicked,lock):
    global gallery_time,status,historyImg,img_after_collage,img_folder
    while True:
...
if __name__ == '__main__':
    ...
    process_handle_status = multiprocessing.Process(name='process_handle_status', target=handleStatus, args=(new_image_to_display,fotobooth,mouse_clicked,lock))  #handle new frame
    process_handle_status.daemon = True
    process_handle_status.start()


    while True:
        handleFrame(new_image_to_display,fotobooth,mouse_clicked,lock)
        #handleStatus()
        print("main:")
